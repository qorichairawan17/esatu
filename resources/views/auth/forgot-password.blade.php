...
<body>
    ...
    <div class="back-to-home">
        <a href="{{ route('app.signin') }}" class="back-button btn btn-icon btn-primary rounded-pill"><i data-feather="arrow-left" class="icons"></i></a>
    </div>
                            ...
                            @else
                                ...
                                <form class="login-form mt-4" id="send-link-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary rounded-pill">Kirim Tautan Reset</button>
                                                <a href="{{ url()->previous() }}" class="btn btn-danger rounded-pill mt-2">Kembali</a>
                                            </div>
                                        </div>
                                        @if (!Auth::user())
                                            <div class="mx-auto">
