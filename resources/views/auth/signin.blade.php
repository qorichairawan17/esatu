                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input type="password" class="form-control @error('password') is-invalid @enderror ps-5 pe-5" placeholder="Password" id="password" name="password"
                                                    required value="{{ old('password') }}">
                                                <span class="position-absolute" style="right: 15px; top: 10px; cursor: pointer; z-index: 10;" onclick="togglePassword()">
                                                    <i class="mdi mdi-eye-outline" id="togglePasswordIcon" style="font-size: 1.2rem; color: #a1a1a5;"></i>
                                                </span>
                                    ...
                                    <div class="col-lg-12 mb-0">
                                        ...
                                        <div class="d-grid mt-3">
                                            <button class="btn btn-primary rounded-pill" type="submit" id="login-button">Masuk</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 mt-2 text-center">
                                        ...
                                        <div class="d-grid mt-2">
                                            <a href="{{ route('google.redirect', ['action' => 'login']) }}" class="btn btn-outline-danger rounded-pill"><i class="mdi mdi-google text-danger"></i>
                                                Google
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body py-5">
                        <div class="text-center">
                            ...
                            <div class="mt-4">
                                ...
                                <button class="btn btn-primary rounded-pill btn-md" data-bs-dismiss="modal">Tutup</button>
                            </div>
                        </div>
                    </div>
                </div>
