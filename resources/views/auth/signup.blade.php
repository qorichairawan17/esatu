                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input type="password" class="form-control @error('password') is-invalid @enderror ps-5 pe-5" placeholder="**********" id="password" name="password"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="d-grid mt-2">
                                            <button class="btn btn-primary rounded-pill" type="submit" id="register-button">Daftar</button>
                                        </div>
                                    </div>
