<header id="topnav" class="defaultscroll sticky">
    <div class="container">
        <a class="logo" href="{{ route('app.home') }}">
            <img src="{{ asset('icons/navbar.png') }}" height="45" class="logo-light-mode" alt="">
            <img src="{{ asset('icons/navbar-white.png') }}" height="45" class="logo-dark-mode" alt="">
        </a>
        ...
        <ul class="buy-button list-inline mb-0 d-none d-lg-inline-block">
            <li class="list-inline-item ps-1 mb-0">
                @if (Auth::check())
                    <a href="{{ route('dashboard.pengguna') }}" class="btn btn-pills btn-success">
