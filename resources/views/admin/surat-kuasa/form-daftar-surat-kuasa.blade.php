                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="alert bg-soft-warning fw-medium" role="alert">
                                <i class="uil uil-info-circle fs-5 align-middle me-1"></i>Perhatian !<br>
                                <p style="text-align: justify;" class="m-0">
                                    Harap mengisi data dengan teliti dan menggunakan informasi yang benar serta valid. Setiap kesalahan atau ketidaksesuaian data akan menyebabkan pengajuan ditolak oleh
                                    petugas verifikasi.<br>
                                    Perlu diperhatikan bahwa setiap pendaftaran surat kuasa yang telah disetujui tidak dapat diubah kembali dalam kondisi apa pun.
                                </p>
                            </div>
                            @php
                            ...
                            <form id="form-pendaftaran-surat-kuasa" action="{{ $formAction }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="border-top pt-3">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#pemberi-surat-kuasa" class="btn btn-sm btn-primary btn-pills mb-3">
                                ...
                                <div class="border-top pt-3">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#penerima-surat-kuasa" class="btn btn-sm btn-primary btn-pills mb-3">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            let pemberiKuasaList = initializePartyList(pemberiStorageKey, {{ \Illuminate\Support\Js::from(json_decode($pihakPemberi)) }});
            let penerimaKuasaList = initializePartyList(penerimaStorageKey, {{ \Illuminate\Support\Js::from(json_decode($pihakPenerima)) }});
            ...
            // --- Cleanup modal backdrop to prevent page from being blocked ---
            $('#pemberi-surat-kuasa, #penerima-surat-kuasa').on('hidden.bs.modal', function() {
                // Remove any leftover backdrop overlays
