...
<nav id="sidebar" class="sidebar-wrapper sidebar-light">
    <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
        <div class="sidebar-brand">
            <a href="{{ $urlDashboard }}">
                <img src="{{ asset('icons/navbar.png') }}" height="50" class="logo-light-mode" alt="logo">
                <img src="{{ asset('icons/navbar-white.png') }}" height="50" class="logo-dark-mode" alt="logo">
                <span class="sidebar-colored">
                    <img src="{{ asset('icons/navbar-white.png') }}" height="50" alt="logo">
                </span>
            </a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            @if (Auth::user()->role !== \App\Enum\RoleEnum::User->value)
            <li class="sidebar">
                <a href="{{ route('monitoring.index') }}"><i class="ti ti-chart-infographic me-2"></i>Monitoring Evaluasi</a>
            </li>
            @endif
            @if (Auth::user()->role == \App\Enum\RoleEnum::Superadmin->value)
            <li class="sidebar-dropdown">
