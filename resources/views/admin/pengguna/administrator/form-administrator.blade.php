            ...
            <div class="layout-specing">
                ...
                <div class="mt-4">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="{{ route('administrator.store') }}" method="POST" id="administrator-form" enctype="multipart/form-data">
                                @csrf
                                @if (isset($user))
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('administrator-form');
