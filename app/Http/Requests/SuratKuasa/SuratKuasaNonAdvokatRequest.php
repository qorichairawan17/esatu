...
class SuratKuasaNonAdvokatRequest extends FormRequest
{
    ...
    public function rules($isUpdate = false): array
    {
        ...
        $fileRules = $isUpdate ? ['sometimes', 'nullable'] : ['required'];

        return [
            'perihal' => 'required|string',
            'jenisSurat' => 'required|string',
            'ktp' => [...$fileRules, 'file', 'mimes:pdf', 'max:5120'],
            'ktpp' => [...$fileRules, 'file', 'mimes:pdf', 'max:5120'],
            'suratTugas' => [...$fileRules, 'file', 'mimes:pdf', 'max:5120'],
            'suratKuasa' => [...$fileRules, 'file', 'mimes:pdf', 'max:10240'],
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'ktpp.max' => 'Ukuran Kartu Tanda Pegawai tidak boleh lebih dari 5MB.',
            ...
            'suratTugas.max' => 'Ukuran Surat Tugas tidak boleh lebih dari 5MB.',
