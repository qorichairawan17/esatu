...
class PendaftaranSuratKuasaModel extends Model
{
    ...
    public function canBeDeletedBy(User $user): bool
    {
        ...
        return $this->belongsToUser($user) && $this->isTahapanPendaftaran();
    }
    ...
    private function isTahapanPendaftaran(): bool
    {
        return $this->tahapan === TahapanSuratKuasaEnum::Pendaftaran->value;
    }
}
